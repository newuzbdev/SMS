...
const SingleTeacherPage = () => {
  return (
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row border">
      {/* LEFT */}
          ...
          <div className="bg-lamaSky py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                <h1 className="text-xl font-semibold dark:text-white">Leonard Snyder</h1>
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                ...
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                  ...
                  <span className="dark:text-white">+1 234 567</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 flex gap-4 justify-between flex-wrap">
            ...
            <div className="p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              <div className="">
                ...
                <span className="text-sm dark:text-white">Attendance</span>
              </div>
            </div>
            {/* CARD */}
            <div className="p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              />
              <div className="">
                <h1 className="text-xl font-semibold dark:text-white">2</h1>
                <span className="text-sm dark:text-white">Branches</span>
              </div>
            </div>
            {/* CARD */}
            <div className="p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:w-[45%] 2xl:w-[48%]">
              ...
              />
              <div className="">
                <h1 className="text-xl font-semibold dark:text-white">6</h1>
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500 dark:text-gray-300">
            ...
            <Link className="p-3 rounded-md" href="/">
              Teachers Exams
            </Link>
            <Link className="p-3 rounded-md bg-lamaSkyLight" href="/">
